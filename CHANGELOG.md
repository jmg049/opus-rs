...
- SILK decoder groundwork (§4.2): module scaffold, all 69 static tables extracted mechanically from the reference sources (cross-file spot pins), and the fixed-point arithmetic kernels pinned against outputs of the compiled reference headers
