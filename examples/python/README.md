...
Runnable examples for the `opus_native` Python bindings. Each is self-contained
...
pip install target/wheels/opus_native-*.whl  # install it
...
| `06_lowlevel_silk_lpc.py` | The `opus_native.lowlevel` SILK codec and LPC analysis |
